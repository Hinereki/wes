document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        ...
        { time: 10, text: "You found me when I was broken" },
        { time: 13, text: "Put me back together, gave me life" },
        { time: 20, text: "Like a flower in the concrete" },
        { time: 25, text: "So beautiful and rare" },
        { time: 31, text: "You gave me hope when I was empty" },
        { time: 33, text: "Walked me through the fire, you were there" },
        { time: 41, text: "You're the sun to the moon" },
